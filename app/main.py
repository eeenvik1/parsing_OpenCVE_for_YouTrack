...
broke_cve_line = parsing_opencve() # Получение списка новых cve с сайта opencve.io
...
cve_line = []
for cve in broke_cve_line: # Удаление лишеного пробела в конце идентификаторов CVE
    cve_line.append(cve[:-1])
